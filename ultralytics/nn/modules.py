...
class CBAM(nn.Module):
    def __init__(self, c1, c2, kernel_size=7, ratio=16):
        ...
        # c2 is output channels, usually same as c1 for attention modules
        # We can use c2 if we want to support channel change, but CBAM usually doesn't.
        # For now, we assume c1 == c2 or we just use c1 for the attention map calculation.
        # If c1 != c2, we might need a projection, but standard CBAM is c1->c1.
        # The parse_model passes c1, c2.
